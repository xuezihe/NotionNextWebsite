...
const BLOG = {
  ...
  BIO: process.env.NEXT_PUBLIC_BIO || 'Technical Art/ Game Maker/ Programmer', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://blog.xuezihe.com', // 网站地址
  ...
  CONTACT_GITHUB: process.env.NEXT_PUBLIC_CONTACT_GITHUB || 'https://github.com/xuezihe', // 你的github个人主页 例如 https://github.com/tangly1024
